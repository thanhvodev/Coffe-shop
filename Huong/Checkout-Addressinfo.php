...
<body>
    ...
    <div style="padding-left: 25%;margin-top: 10px;">
        ...
        &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <input type="text" id="fullname" <?php if ($cus != NULL) echo "value=" . "'" . $cus['FULLNAME'] . "'"; ?>> <br>
        <label style="font-size: 18px; margin-top:20px; margin-left: 50px;" for="phone">Số điện thoại: </label>
        &nbsp;&nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <input type="text" id="phone" <?php if ($cus != NULL) echo "value=" . "'" . $cus['PHONE_NO'] . "'"; ?>> <br><br>
        ...
        &nbsp; <input type="text" id="street" <?php if ($cus != NULL) echo "value=" . "'" . $cus['NUMANDSTREET'] . "'"; ?>> <br>
        <label style="font-size: 18px; margin-top:20px; margin-left: 50px;" for="district">Quận: </label>
        &nbsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; <input type="text" id="district" <?php if ($cus != NULL) echo "value=" . "'" . $cus['DISTRICT'] . "'"; ?>> <br><br>
    </div>
